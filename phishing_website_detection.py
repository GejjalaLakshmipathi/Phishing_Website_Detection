...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('We used _supervised learning_ to classify phishing and legitimate websites. '
             'It benefit from content-based approach and focus on html of the websites. '
             'Also, used scikit-learn for the ML models.'
             )
    ...
    st.write('https://github.com/GejjalaLakshmipathi/Phishing_Website_Detection')
    ...
    st.write('Firstly we used only content-based features. We didn\'t use url-based faetures like length of url etc.'
